 ...
 ***************************************************************************/
"""
#Duplicate module to stdm.ui.DeclareMapping to fix cyclic import issues.
...
class DeclareMapping(object):
    """
    Provides util methods for mapping tables to sqlalchemy models.
    """
