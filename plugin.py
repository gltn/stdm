...
class STDMQGISLoader(object):
    ...
    def loadModules(self):
        ...
        self.uploadAct = QAction(QIcon(":/plugins/stdm/images/icons/docupload.png"), \
        QApplication.translate("UploadAction","Upload Scanned Documents"), self.iface.mainWindow())
