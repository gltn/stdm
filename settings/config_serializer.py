...
class AutoGeneratedColumnSerializer(ColumnSerializerCollection):
    ...
    def _obj_args(cls, args, kwargs, element, assoc_elements,
        ...
        if not code_ele.isNull():
            ...
            enable_serial = code_ele.attribute(
                AutoGeneratedColumnSerializer.ENABLE_SERIAL,
                'True'
            )
            ...
            kwargs['enable_serial'] = enable_serial
    ...
    def _write_xml(cls, column, column_element, document):
        ...
        dt_element.setAttribute('enable_serial', column.enable_serial)
        dt_element.setAttribute('enable_editing', column.enable_editing)
