...
def resetwarnings():
    ...
    util.warn = stdm.stdm.third_party.sqlalchemy.util.langhelpers.warn = testing_warn
...
def assert_warnings(fn, warnings, regex=False):
    ...
    def capture_warnings(*args, **kw):
        ...
        if regex:
            ...
            eq_(args[0], popwarn)
    util.warn = stdm.stdm.third_party.sqlalchemy.util.langhelpers.warn = capture_warnings
