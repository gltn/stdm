...
class ColumnEntitiesModel(QStandardItemModel):
    ...
    headers_labels = ["Name", "STDM Data Type", "Description", "ODK Data Type", "Appearance"]

    def __init__(self, parent=None):
        super(ColumnEntitiesModel, self).__init__(parent)
        self._entities = OrderedDict()
        self.odk_data_type_and_appearance = {
            'Varying-length Text': ['text', 'none'],
    ...
    def _add_row(self, entity):
        ...
        QgsMessageLog.logMessage('data type {data_type_name} type info {type_info} '
                                 .format(data_type_name=data_type_name, type_info=entity.TYPE_INFO), 'STDM dev')
        ...
        odk_data_type_name_column = ColumnEntityModelItem(odk_data_type_name)
        odk_data_type_appearance_column = ColumnEntityModelItem(odk_data_type_appearance)
        ...
        self.appendRow([
            ...
            data_type_column,
            description_column,
            odk_data_type_name_column,
            odk_data_type_appearance_column]
        )
