...
class Ui_STREditor(object):
    def setupUi(self, STREditor):
        ...
        STREditor.setMinimumSize(QtCore.QSize(600, 400))
        ...
        self.str_tree_view_frame.setMaximumSize(QtCore.QSize(350, 500000))
        ...
        self.componentPage41 = QtGui.QWidget()
        self.componentPage41.setObjectName(_fromUtf8("componentPage41"))
        self.verticalLayout_11 = QtGui.QVBoxLayout(self.componentPage41)
        self.verticalLayout_11.setObjectName(_fromUtf8("verticalLayout_11"))
        self.cont_box = QtGui.QVBoxLayout()
        self.cont_box.setObjectName(_fromUtf8("cont_box"))
        self.custom_tenure_tab = QtGui.QTabWidget(self.componentPage41)
        self.custom_tenure_tab.setObjectName(_fromUtf8("custom_tenure_tab"))
        self.cont_box.addWidget(self.custom_tenure_tab)
        self.verticalLayout_11.addLayout(self.cont_box)
        self.component_container.addWidget(self.componentPage41)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.doc_type_cbo.sizePolicy().hasHeightForWidth())
        self.doc_type_cbo.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.add_documents_btn.sizePolicy().hasHeightForWidth())
        self.add_documents_btn.setSizePolicy(sizePolicy)
        self.add_documents_btn.setMinimumSize(QtCore.QSize(0, 30))
        self.add_documents_btn.setMaximumSize(QtCore.QSize(16777215, 32))
        icon2 = QtGui.QIcon()
...
from stdm.stdm.ui.property_preview import SpatialPreview
