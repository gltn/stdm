...
class Ui_dlgColumnDepend(object):
    def setupUi(self, dlgColumnDepend):
        ...
        dlgColumnDepend.resize(399, 296)
        ...
        self.qryLabel.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
    ...
    def retranslateUi(self, dlgColumnDepend):
        ...
        self.qryLabel.setText(_translate("dlgColumnDepend", "The following items depend on the \'%1\' column;\n"
