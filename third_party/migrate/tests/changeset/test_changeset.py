...
class TestAddDropColumn(fixture.DB):
    ...
    def test_fk(self):
        ...
        # TODO: tests on db level if constraints work
    ...
    def test_pk(self):
        ...
        # check if constraint was added (cannot tests on objects)
...
# TODO: remove already attached columns with uniques, pks, fks ..
    ...
    # TODO: tests sequence
    # TODO: tests quoting
    # TODO: tests non-autoname constraints
...
class TestRename(fixture.DB):
    ...
    def test_rename_table(self):
        ...
        def assert_table_name(expected, skip_object_check=False):
            ...
            SA has changed some since this tests was written; we now need to do
...
class TestColumnDelta(fixture.DB):
    ...
    def test_deltas_one_column(self):
        ...
        # TODO: tests server on update
        # TODO: tests bind metadata
