...
class TestSchemaDiff(fixture.DB):
    ...
    # so the schema diffs on the columns don't work with this tests.
    ...
    def test_functional(self):
        ...
        # Feature tests for a recent SQLa feature;
        ...
        if not self.engine.name == 'firebird':
            ...
            assertDiff(True, [], [], [self.table_name])  # TODO tests nullable diff
