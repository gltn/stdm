...
class TestRepository(fixture.Pathed):
    ...
    def test_load_invalid(self):
        ...
        # but we shouldn't need to tests all of them
        path = self.tmp_repos()
        os.mkdir(path)
        self.assertRaises(exceptions.InvalidRepositoryError, Repository, path)
...
class TestVersionedRepository(fixture.Pathed):
    ...
    def test_version(self):
        ...
        # Create a script and tests again
        repos.create_script('')
        ...
        # Create a new script and tests again
        repos.create_script('')
    ...
    def test_source(self):
        ...
        # (not a very thorough tests, but should be plenty)
...
# TODO: tests manage file
# TODO: tests changeset
