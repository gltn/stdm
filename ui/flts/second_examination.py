"""
/***************************************************************************
Name                 : Second Examination Widget
Description          : A widget for performing second examination  on a scheme.
Date                 : 07/August/2019
copyright            : (C) 2019
 ***************************************************************************/
...
class SecondExaminationWidget(QWidget, Ui_WorkflowManagerWidget):
    """
    Manages Second Examination notifications and workflow
    """
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("Second Workflow Manager")
        self.setObjectName("secondExamination")
