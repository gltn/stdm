...
# Form implementation generated from reading ui file 'ui_import_plots.ui'
#
# Created: Sat Jul  6 21:38:39 2019
...
class Ui_frmImportPlot(object):
    def setupUi(self, frmImportPlot):
        frmImportPlot.setObjectName(_fromUtf8("frmImportPlot"))
        frmImportPlot.resize(693, 423)
        frmImportPlot.setWizardStyle(QtGui.QWizard.ModernStyle)
        frmImportPlot.setOptions(QtGui.QWizard.HelpButtonOnRight)
        ...
        frmImportPlot.addPage(self.pgSource)
        ...
        frmImportPlot.addPage(self.destTable)
        ...
        frmImportPlot.addPage(self.assignColumns)

        self.retranslateUi(frmImportPlot)
        QtCore.QMetaObject.connectSlotsByName(frmImportPlot)

    def retranslateUi(self, frmImportPlot):
        frmImportPlot.setWindowTitle(_translate("frmImportPlot", "Import Plots", None))
        self.pgSource.setTitle(_translate("frmImportPlot", "Source Data", None))
        self.pgSource.setSubTitle(_translate("frmImportPlot", "Specify the location of the source file and representative data type.", None))
        self.groupBox.setTitle(_translate("frmImportPlot", "Source:", None))
        self.label.setText(_translate("frmImportPlot", "Geo Data", None))
        self.btnBrowseSource.setText(_translate("frmImportPlot", "Browse", None))
        self.groupBox_2.setTitle(_translate("frmImportPlot", "Destination Repository Type:", None))
        self.rbTextType.setText(_translate("frmImportPlot", "Textual Data", None))
        self.rbSpType.setText(_translate("frmImportPlot", "Spatial Data", None))
        self.destTable.setTitle(_translate("frmImportPlot", "Copy Table", None))
        self.destTable.setSubTitle(_translate("frmImportPlot", "Destination table and import options.", None))
        self.groupBox_3.setTitle(_translate("frmImportPlot", "Select Destination Table:", None))
        self.groupBox_4.setTitle(_translate("frmImportPlot", "Options:", None))
        self.label_2.setText(_translate("frmImportPlot", "Geometry Column:", None))
        self.rbAppend.setText(_translate("frmImportPlot", "A&ppend Data", None))
        self.rbOverwrite.setText(_translate("frmImportPlot", "&Overwrite Existing", None))
        self.assignColumns.setTitle(_translate("frmImportPlot", "Assign Columns", None))
        self.assignColumns.setSubTitle(_translate("frmImportPlot", "Match source and destination table columns.", None))
        self.groupBox_5.setTitle(_translate("frmImportPlot", "Source Table:", None))
        self.btnSrcAll.setText(_translate("frmImportPlot", "Select All", None))
        self.btnSrcNone.setText(_translate("frmImportPlot", "Unsellect All", None))
        self.groupBox_6.setTitle(_translate("frmImportPlot", "Destination Table:", None))
        self.lstTargetFields.setSortingEnabled(False)
        self.chk_virtual.setText(_translate("frmImportPlot", "Show virtual columns", None))
        self.label_3.setText(_translate("frmImportPlot", "Value translators:", None))
        self.btn_add_translator.setToolTip(_translate("frmImportPlot", "Add value translator", None))
        self.btn_add_translator.setWhatsThis(_translate("frmImportPlot", "<html><head/><body><p>Use value translators to transform the value from the corresponding source table column in order to adopt it to a format that adaptible to the destination column.</p></body></html>", None))
        self.btn_edit_translator.setToolTip(_translate("frmImportPlot", "Edit value translator", None))
        self.btn_delete_translator.setToolTip(_translate("frmImportPlot", "Delete value translator", None))
