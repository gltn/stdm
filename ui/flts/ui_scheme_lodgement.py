...
class Ui_ldg_wzd(object):
    ...
    def retranslateUi(self, ldg_wzd):
        ...
        self.label_desc.setText(_translate("ldg_wzd", "<html><head/><body><p>Enter scheme information below. Please note the scheme and SG number will be automatically generated</p></body></html>", None))
