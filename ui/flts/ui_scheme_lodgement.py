...
class Ui_ldg_wzd(object):
    def setupUi(self, ldg_wzd):
        ...
        self.gridLayout_2.addWidget(self.label_schm_num, 2, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label_schm_name, 3, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label_date_apprv, 4, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label_date_establish, 5, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label_region, 6, 0, 1, 1)
        self.cbx_region = QtGui.QComboBox(self.wizardPage1)
        self.cbx_region.setObjectName(_fromUtf8("cbx_region"))
        self.gridLayout_2.addWidget(self.cbx_region, 6, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label_rel_auth_type, 7, 0, 1, 1)
        self.cbx_relv_auth = QtGui.QComboBox(self.wizardPage1)
        self.cbx_relv_auth.setObjectName(_fromUtf8("cbx_relv_auth"))
        self.gridLayout_2.addWidget(self.cbx_relv_auth, 7, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label_rel_auth_name, 8, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.cbx_relv_auth_name, 8, 1, 1, 1)
