...
class Ui_ldg_wzd(object):
    def setupUi(self, ldg_wzd):
        ...
        self.gridLayout_2.addWidget(self.label_desc, 0, 0, 1, 2)
        self.vlNotification = QtGui.QVBoxLayout()
        self.vlNotification.setContentsMargins(4, 5, 4, 5)
        self.vlNotification.setObjectName(_fromUtf8("vlNotification"))
        self.gridLayout_2.addLayout(self.vlNotification, 1, 0, 1, 2)
