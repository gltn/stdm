...
class Ui_ldg_wzd(object):
    def setupUi(self, ldg_wzd):
        ...
        self.lnedit_reg_div = QtGui.QLineEdit(self.wizardPage1)
        self.lnedit_reg_div.setReadOnly(True)
        self.lnedit_reg_div.setObjectName(_fromUtf8("lnedit_reg_div"))
        self.gridLayout_2.addWidget(self.lnedit_reg_div, 5, 1, 1, 1)
