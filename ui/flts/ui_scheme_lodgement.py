...
#
# Created: Mon Jul 15 16:18:02 2019
...
class Ui_ldg_wzd(object):
    ...
    def retranslateUi(self, ldg_wzd):
        ...
        self.desc_Label2.setText(QtGui.QApplication.translate("ldg_wzd", "This step entails locating and importing the list of holders file.  ", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.lbl_upld.setText(QtGui.QApplication.translate("ldg_wzd", "Click Upload button to save data.", None, QtGui.QApplication.UnicodeUTF8))
        self.btn_valid_upld.setText(QtGui.QApplication.translate("ldg_wzd", "Upload", None, QtGui.QApplication.UnicodeUTF8))
        self.desc_Label2_2.setText(QtGui.QApplication.translate("ldg_wzd", "Below is a list for required documents. Click Browse to add individual documents or upload multiple documents.", None, QtGui.QApplication.UnicodeUTF8))
        self.btn_upld_multi.setText(QtGui.QApplication.translate("ldg_wzd", "Upload Documents", None, QtGui.QApplication.UnicodeUTF8))
