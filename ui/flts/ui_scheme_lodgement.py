...
#
# Created: Thu Oct 24 22:47:58 2019
...
class Ui_ldg_wzd(object):
    def setupUi(self, ldg_wzd):
        ...
        self.gridLayout_2.addWidget(self.label_sg_num, 7, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.lnedit_sg_num, 7, 1, 1, 1)
        self.label_const_ref_num = QtGui.QLabel(self.wizardPage1)
        self.label_const_ref_num.setObjectName(_fromUtf8("label_const_ref_num"))
        self.gridLayout_2.addWidget(self.label_const_ref_num, 8, 0, 1, 1)
        self.lnedit_const_ref_num = QtGui.QLineEdit(self.wizardPage1)
        self.lnedit_const_ref_num.setReadOnly(False)
        self.lnedit_const_ref_num.setObjectName(_fromUtf8("lnedit_const_ref_num"))
        self.gridLayout_2.addWidget(self.lnedit_const_ref_num, 8, 1, 1, 1)
        self.label_schm_name = QtGui.QLabel(self.wizardPage1)
        self.label_schm_name.setObjectName(_fromUtf8("label_schm_name"))
        self.gridLayout_2.addWidget(self.label_schm_name, 9, 0, 1, 1)
        self.lnedit_schm_nam = QtGui.QLineEdit(self.wizardPage1)
        self.lnedit_schm_nam.setObjectName(_fromUtf8("lnedit_schm_nam"))
        self.gridLayout_2.addWidget(self.lnedit_schm_nam, 9, 1, 1, 1)
        self.label_date_apprv = QtGui.QLabel(self.wizardPage1)
        self.label_date_apprv.setObjectName(_fromUtf8("label_date_apprv"))
        self.gridLayout_2.addWidget(self.label_date_apprv, 10, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.date_apprv, 10, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label_date_establish, 11, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.dbl_spinbx_block_area, 14, 1, 1, 1)
        self.label_num_plots = QtGui.QLabel(self.wizardPage1)
        self.label_num_plots.setObjectName(_fromUtf8("label_num_plots"))
        self.gridLayout_2.addWidget(self.label_num_plots, 15, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.dbl_spinbx_num_plots, 15, 1, 1, 1)
    ...
    def retranslateUi(self, ldg_wzd):
        ...
        self.label_const_ref_num.setText(_translate("ldg_wzd", "Constitution Ref. Number", None))
        ...
        self.label_blck_area.setText(_translate("ldg_wzd", "Block Area (Hectares)", None))
