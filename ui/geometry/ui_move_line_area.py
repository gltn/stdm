...
class Ui_MoveLineArea(object):
    def setupUi(self, MoveLineArea):
        ...
        self.gridLayout.addWidget(self.split_polygon_area, 2, 1, 1, 3)
        self.preview_btn = QtGui.QPushButton(MoveLineArea)
        self.preview_btn.setObjectName(_fromUtf8("preview_btn"))
        self.gridLayout.addWidget(self.preview_btn, 3, 1, 1, 1)
        self.save_btn = QtGui.QPushButton(MoveLineArea)
    ...
    def retranslateUi(self, MoveLineArea):
        ...
        self.save_btn.setText(_translate("MoveLineArea", "Save", None))
