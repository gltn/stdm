...
class Ui_OffsetDistance(object):
    def setupUi(self, OffsetDistance):
        ...
        self.label_25 = QtGui.QLabel(OffsetDistance)
        ...
        self.label_29 = QtGui.QLabel(OffsetDistance)
        ...
        self.pushButton_6 = QtGui.QPushButton(OffsetDistance)
        self.pushButton_6.setObjectName(_fromUtf8("pushButton_6"))
        self.gridLayout.addWidget(self.pushButton_6, 4, 0, 1, 1)
        self.pushButton_5 = QtGui.QPushButton(OffsetDistance)
        self.pushButton_5.setObjectName(_fromUtf8("pushButton_5"))
        self.gridLayout.addWidget(self.pushButton_5, 4, 1, 1, 1)
        self.pushButton_4 = QtGui.QPushButton(OffsetDistance)
    ...
    def retranslateUi(self, OffsetDistance):
        ...
        self.label_25.setText(_translate("OffsetDistance", "0", None))
        ...
        self.label_29.setText(_translate("OffsetDistance", "0", None))
        ...
        self.pushButton_6.setText(_translate("OffsetDistance", "Cancel", None))
        self.pushButton_5.setText(_translate("OffsetDistance", "Preview", None))
        self.pushButton_4.setText(_translate("OffsetDistance", "Save", None))
