...
class Ui_OnePointArea(object):
    def setupUi(self, OnePointArea):
        ...
        self.gridLayout.addWidget(self.anticlockwise, 7, 2, 1, 1)
        self.preview_btn = QtGui.QPushButton(OnePointArea)
        self.preview_btn.setObjectName(_fromUtf8("preview_btn"))
        self.gridLayout.addWidget(self.preview_btn, 8, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.split_polygon_area, 5, 2, 1, 2)
        self.cancel_btn = QtGui.QPushButton(OnePointArea)
        self.cancel_btn.setObjectName(_fromUtf8("cancel_btn"))
        self.gridLayout.addWidget(self.cancel_btn, 8, 1, 1, 1)
        spacerItem = QtGui.QSpacerItem(20, 40, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.gridLayout.addItem(spacerItem, 9, 2, 1, 1)
        self.run_btn = QtGui.QPushButton(OnePointArea)
        ...
        self.gridLayout.addWidget(self.clockwise, 6, 2, 1, 1)
    ...
    def retranslateUi(self, OnePointArea):
        ...
        self.run_btn.setText(_translate("OnePointArea", "Run", None))
