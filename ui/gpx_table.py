...
class GpxTableWidgetDialog(QDialog, Ui_Dialog):
    ...
    def gpx_table_widget_item_pressed(self, item):
        ...
        """
        self.table_pressed_status = False
        # QMessageBox.information(None, "STDM", "{0} {1}".format("I have been pressed", self.table_pressed_status))
    ...
    def gpx_table_widget_item_selection_changed(self):
        ...
        # QMessageBox.information(None, "STDM", "{0}".format(unique_rows))
    ...
    def gpx_table_widget_item_clicked(self, item):
        ...
        """
        # QMessageBox.information(None, "STDM", "{0} {1}".format("I have been clicked", self.table_pressed_status))
                    ...
                    if row == item.row():
                        ...
                        if self.active_layer_geometry_typ == 0:
                            for item_row, chkbx_item in self.prv_chkbx_itm_placeholder_dict.iteritems():
                                ...
                                # If user deselects same row as previously select row pass
                                if item_row == item.row():
                                    pass

                                # Else if row is different deselect previous row
                                else:
