...
class Ui_STREditor(object):
    def setupUi(self, STREditor):
        ...
        self.add_str_btn = QtGui.QToolButton(STREditor)
        ...
        self.horizontalLayout.addWidget(self.add_str_btn)
        self.remove_str_btn = QtGui.QToolButton(STREditor)
        ...
        self.horizontalLayout.addWidget(self.remove_str_btn)
        ...
        self.tree_view_container.setGeometry(QtCore.QRect(0, 0, 328, 439))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.str_type_widget.setGeometry(QtCore.QRect(0, 0, 631, 427))
    ...
    def retranslateUi(self, STREditor):
        ...
        self.label.setText(_translate("STREditor", "Upload one or more supprting documents under each document types (Optional).", None))
