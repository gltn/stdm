...
#
# Created: Fri May 22 12:40:39 2020
...
class Ui_DocumentDownloader(object):
    def setupUi(self, DocumentDownloader):
        ...
        self.rbScannedDoc = QtGui.QRadioButton(self.groupBox_2)
        self.rbScannedDoc.setObjectName(_fromUtf8("rbScannedDoc"))
        self.horizontalLayout.addWidget(self.rbScannedDoc)
        ...
        self.edtScannedDoc = QtGui.QLineEdit(self.groupBox_8)
        self.edtScannedDoc.setObjectName(_fromUtf8("edtScannedDoc"))
        self.gridLayout_6.addWidget(self.edtScannedDoc, 5, 1, 1, 1)
        self.cbScannedDoc = QtGui.QCheckBox(self.groupBox_8)
        self.cbScannedDoc.setObjectName(_fromUtf8("cbScannedDoc"))
        self.gridLayout_6.addWidget(self.cbScannedDoc, 5, 2, 1, 1)
        self.tbScannedDoc = QtGui.QToolButton(self.groupBox_8)
        self.tbScannedDoc.setObjectName(_fromUtf8("tbScannedDoc"))
        self.gridLayout_6.addWidget(self.tbScannedDoc, 5, 3, 1, 1)
        self.btnScannedDoc = QtGui.QPushButton(self.groupBox_8)
        self.btnScannedDoc.setObjectName(_fromUtf8("btnScannedDoc"))
        self.gridLayout_6.addWidget(self.btnScannedDoc, 5, 4, 1, 1)
    ...
    def retranslateUi(self, DocumentDownloader):
        ...
        self.label_2.setText(_translate("DocumentDownloader", "Scanned Cert.:", None))
        ...
        self.cbScannedDoc.setText(_translate("DocumentDownloader", "Download", None))
