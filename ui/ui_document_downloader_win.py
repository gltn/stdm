...
#
# Created: Mon Oct 04 15:32:19 2021
...
class Ui_DocumentDownloader(object):
    def setupUi(self, DocumentDownloader):
        ...
        self.edtUploadFile = QtGui.QLineEdit(self.groupBox_3)
        self.edtUploadFile.setObjectName(_fromUtf8("edtUploadFile"))
        self.horizontalLayout_6.addWidget(self.edtUploadFile)
        self.btnUploadFile = QtGui.QPushButton(self.groupBox_3)
        self.btnUploadFile.setMinimumSize(QtCore.QSize(0, 25))
        self.btnUploadFile.setObjectName(_fromUtf8("btnUploadFile"))
        self.horizontalLayout_6.addWidget(self.btnUploadFile)
        ...
        self.gridLayout.addWidget(self.edtScannedFamilyPhoto, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.tbScannedFamilyPhoto, 4, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.btnScannedFamilyPhoto, 4, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.cbScannedFamilyPhoto, 4, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.edtScannedSignature, 5, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.cbScannedSignature, 5, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.tbScannedSignature, 5, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.btnScannedSignature, 5, 4, 1, 1)
    ...
    def retranslateUi(self, DocumentDownloader):
        ...
        self.groupBox_3.setTitle(_translate("DocumentDownloader", "Data Source:", None))
