...
class Ui_DocumentUploader(object):
    def setupUi(self, DocumentUploader):
        ...
        DocumentUploader.resize(750, 442)
        ...
        self.gridLayout.addWidget(self.btnFolder, 0, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.edtFolder, 0, 1, 1, 4)
        ...
        self.gridLayout.addWidget(self.btnUpload, 3, 4, 1, 1)
        self.btnCancel = QtGui.QPushButton(self.centralwidget)
        self.btnCancel.setObjectName(_fromUtf8("btnCancel"))
        self.gridLayout.addWidget(self.btnCancel, 3, 5, 1, 1)
    ...
    def retranslateUi(self, DocumentUploader):
        DocumentUploader.setWindowTitle(_translate("DocumentUploader", "Save Scanned Document to Database", None))
        ...
        self.btnUpload.setText(_translate("DocumentUploader", "Save", None))
        self.btnCancel.setText(_translate("DocumentUploader", "Close", None))
        self.cbAllowDuplicate.setText(_translate("DocumentUploader", "Allow Saving Duplicates", None))
        self.cbAllowDuplicate.setCheckState(Qt.Checked)
        self.cbDelAfterUpload.setText(_translate("DocumentUploader", "Delete Documents After Save", None))
