...
class Ui_frmImport(object):
    def setupUi(self, frmImport):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/stdm/images/icons/down.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnSrcDown.setIcon(icon)
        self.btnSrcDown.setObjectName(_fromUtf8("btnSrcDown"))
        self.gridLayout_7.addWidget(self.btnSrcDown, 1, 1, 1, 1)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/stdm/images/icons/up.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnSrcUp.setIcon(icon1)
        self.btnSrcUp.setObjectName(_fromUtf8("btnSrcUp"))
        self.gridLayout_7.addWidget(self.btnSrcUp, 0, 1, 1, 1)
        spacerItem = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout_7.addItem(spacerItem, 0, 0, 1, 1)
        self.gridLayout_3.addLayout(self.gridLayout_7, 0, 3, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.btnSrcNone, 2, 3, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.lstSrcFields, 0, 5, 5, 1)
        ...
        self.gridLayout_3.addWidget(self.btnSrcAll, 1, 3, 1, 1)
        ...
        self.btn_edit_translator.setIcon(icon2)
