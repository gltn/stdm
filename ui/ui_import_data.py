...
#
# Created: Mon Apr 13 11:26:25 2020
...
class Ui_frmImport(object):
    ...
    def retranslateUi(self, frmImport):
        ...
        self.label_12.setText(_translate("frmImport", "ID Picture", None))
        ...
        self.label_11.setText(_translate("frmImport", "House Picture", None))
        self.cbHousePic.setText(_translate("frmImport", "Download", None))
        self.tbHousePic.setText(_translate("frmImport", "...", None))
        self.btnHousePic.setText(_translate("frmImport", "Browse ...", None))
        self.cbIdPic.setText(_translate("frmImport", "Download", None))
        self.tbIdPic.setText(_translate("frmImport", "...", None))
        self.btnIdPic.setText(_translate("frmImport", "Browse ...", None))
