...
#
# Created: Wed Aug 14 10:03:30 2013
...
class Ui_frmNewSTR(object):
    def setupUi(self, frmNewSTR):
        ...
        self.frmWizRight = QtGui.QWizardPage()
        self.frmWizRight.setObjectName(_fromUtf8("frmWizRight"))
        self.gridLayout = QtGui.QGridLayout(self.frmWizRight)
        self.gridLayout.setHorizontalSpacing(5)
        self.gridLayout.setVerticalSpacing(20)
        self.gridLayout.setObjectName(_fromUtf8("gridLayout"))
        self.cboInheritanceType = QtGui.QComboBox(self.frmWizRight)
        self.cboInheritanceType.setMinimumSize(QtCore.QSize(0, 30))
        self.cboInheritanceType.setObjectName(_fromUtf8("cboInheritanceType"))
        self.gridLayout.addWidget(self.cboInheritanceType, 1, 1, 1, 1)
        self.cboDeadAlive = QtGui.QComboBox(self.frmWizRight)
        self.cboDeadAlive.setMinimumSize(QtCore.QSize(0, 30))
        self.cboDeadAlive.setObjectName(_fromUtf8("cboDeadAlive"))
        self.gridLayout.addWidget(self.cboDeadAlive, 2, 1, 1, 1)
        self.label_5 = QtGui.QLabel(self.frmWizRight)
        self.label_5.setObjectName(_fromUtf8("label_5"))
        self.gridLayout.addWidget(self.label_5, 3, 0, 1, 1)
        self.dtReceivingDate = QtGui.QDateEdit(self.frmWizRight)
        self.dtReceivingDate.setMinimumSize(QtCore.QSize(0, 30))
        self.dtReceivingDate.setCalendarPopup(False)
        self.dtReceivingDate.setObjectName(_fromUtf8("dtReceivingDate"))
        self.gridLayout.addWidget(self.dtReceivingDate, 3, 1, 1, 1)
        self.label_3 = QtGui.QLabel(self.frmWizRight)
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.gridLayout.addWidget(self.label_3, 1, 0, 1, 1)
        self.label_4 = QtGui.QLabel(self.frmWizRight)
        self.label_4.setObjectName(_fromUtf8("label_4"))
        self.gridLayout.addWidget(self.label_4, 2, 0, 1, 1)
        self.vlEnjoymentNotif = QtGui.QVBoxLayout()
        self.vlEnjoymentNotif.setObjectName(_fromUtf8("vlEnjoymentNotif"))
        self.gridLayout.addLayout(self.vlEnjoymentNotif, 0, 0, 1, 2)
        frmNewSTR.addPage(self.frmWizRight)
        ...
        self.rbPrivateProperty = QtGui.QRadioButton(self.groupBox_3)
        self.rbPrivateProperty.setChecked(True)
        self.rbPrivateProperty.setObjectName(_fromUtf8("rbPrivateProperty"))
        self.horizontalLayout_2.addWidget(self.rbPrivateProperty)
        self.rbStateland = QtGui.QRadioButton(self.groupBox_3)
        self.rbStateland.setObjectName(_fromUtf8("rbStateland"))
        self.horizontalLayout_2.addWidget(self.rbStateland)
        self.gridLayout_6.addWidget(self.groupBox_3, 1, 0, 1, 1)
        self.stkSrcDocList = QtGui.QStackedWidget(self.frmWizSourceDocs)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 590, 387))
        self.scrollAreaWidgetContents.setObjectName(_fromUtf8("scrollAreaWidgetContents"))
        self.gridLayout_8 = QtGui.QGridLayout(self.scrollAreaWidgetContents)
        self.gridLayout_8.setObjectName(_fromUtf8("gridLayout_8"))
        self.gpPrivateTaxInfo = QtGui.QGroupBox(self.scrollAreaWidgetContents)
        self.gpPrivateTaxInfo.setCheckable(True)
        self.gpPrivateTaxInfo.setChecked(False)
        self.gpPrivateTaxInfo.setObjectName(_fromUtf8("gpPrivateTaxInfo"))
        self.gridLayout_7 = QtGui.QGridLayout(self.gpPrivateTaxInfo)
        self.gridLayout_7.setObjectName(_fromUtf8("gridLayout_7"))
        self.label_10 = QtGui.QLabel(self.gpPrivateTaxInfo)
        self.label_10.setObjectName(_fromUtf8("label_10"))
        self.gridLayout_7.addWidget(self.label_10, 0, 0, 1, 1)
        self.dtLastYearCFBP = QtGui.QDateEdit(self.gpPrivateTaxInfo)
        self.dtLastYearCFBP.setMinimumSize(QtCore.QSize(0, 30))
        self.dtLastYearCFBP.setCalendarPopup(False)
        self.dtLastYearCFBP.setObjectName(_fromUtf8("dtLastYearCFBP"))
        self.gridLayout_7.addWidget(self.dtLastYearCFBP, 0, 1, 1, 1)
        self.txtCFBPAmount = QtGui.QLineEdit(self.gpPrivateTaxInfo)
        self.txtCFBPAmount.setMinimumSize(QtCore.QSize(0, 30))
        self.txtCFBPAmount.setMaxLength(100)
        self.txtCFBPAmount.setObjectName(_fromUtf8("txtCFBPAmount"))
        self.gridLayout_7.addWidget(self.txtCFBPAmount, 1, 1, 1, 1)
        self.label_11 = QtGui.QLabel(self.gpPrivateTaxInfo)
        self.label_11.setObjectName(_fromUtf8("label_11"))
        self.gridLayout_7.addWidget(self.label_11, 1, 0, 1, 1)
        self.btnPrivateReceiptScan = QtGui.QPushButton(self.gpPrivateTaxInfo)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/stdm/images/icons/receipt.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnPrivateReceiptScan.setIcon(icon)
        self.btnPrivateReceiptScan.setObjectName(_fromUtf8("btnPrivateReceiptScan"))
        self.gridLayout_7.addWidget(self.btnPrivateReceiptScan, 2, 1, 1, 1)
        self.vlPrivateReceiptScan = QtGui.QVBoxLayout()
        self.vlPrivateReceiptScan.setObjectName(_fromUtf8("vlPrivateReceiptScan"))
        self.gridLayout_7.addLayout(self.vlPrivateReceiptScan, 3, 1, 1, 1)
        self.gridLayout_8.addWidget(self.gpPrivateTaxInfo, 0, 0, 1, 1)
        ...
        self.btnAddTitleDeed = QtGui.QPushButton(self.groupBox_4)
        ...
        self.verticalLayout_6.addWidget(self.btnAddTitleDeed)
        self.vlDocTitleDeed = QtGui.QVBoxLayout()
        self.vlDocTitleDeed.setObjectName(_fromUtf8("vlDocTitleDeed"))
        self.verticalLayout_6.addLayout(self.vlDocTitleDeed)
        ...
        self.btnAddStatRefPaper = QtGui.QPushButton(self.groupBox_5)
        self.btnAddStatRefPaper.setMaximumSize(QtCore.QSize(200, 32))
        self.btnAddStatRefPaper.setIcon(icon1)
        self.btnAddStatRefPaper.setObjectName(_fromUtf8("btnAddStatRefPaper"))
        self.verticalLayout_5.addWidget(self.btnAddStatRefPaper)
        self.vlDocStatRefPaper = QtGui.QVBoxLayout()
        self.vlDocStatRefPaper.setObjectName(_fromUtf8("vlDocStatRefPaper"))
        self.verticalLayout_5.addLayout(self.vlDocStatRefPaper)
        ...
        self.btnAddSurveyorRef = QtGui.QPushButton(self.groupBox_6)
        self.btnAddSurveyorRef.setMaximumSize(QtCore.QSize(200, 32))
        self.btnAddSurveyorRef.setIcon(icon1)
        self.btnAddSurveyorRef.setObjectName(_fromUtf8("btnAddSurveyorRef"))
        self.verticalLayout_4.addWidget(self.btnAddSurveyorRef)
        self.vlDocSurveyorRef = QtGui.QVBoxLayout()
        self.vlDocSurveyorRef.setObjectName(_fromUtf8("vlDocSurveyorRef"))
        self.verticalLayout_4.addLayout(self.vlDocSurveyorRef)
        ...
        self.btnAddNotaryRef = QtGui.QPushButton(self.groupBox_10)
        self.btnAddNotaryRef.setMaximumSize(QtCore.QSize(200, 32))
        self.btnAddNotaryRef.setIcon(icon1)
        self.btnAddNotaryRef.setObjectName(_fromUtf8("btnAddNotaryRef"))
        self.verticalLayout_3.addWidget(self.btnAddNotaryRef)
        self.vlDocNotaryRef = QtGui.QVBoxLayout()
        self.vlDocNotaryRef.setObjectName(_fromUtf8("vlDocNotaryRef"))
        self.verticalLayout_3.addLayout(self.vlDocNotaryRef)
        ...
        self.gridLayout_6.addWidget(self.stkSrcDocList, 2, 0, 1, 1)
        ...
        self.frmWizConflict = QtGui.QWizardPage()
        self.frmWizConflict.setObjectName(_fromUtf8("frmWizConflict"))
        self.gridLayout_13 = QtGui.QGridLayout(self.frmWizConflict)
        self.gridLayout_13.setContentsMargins(-1, 9, -1, 9)
        self.gridLayout_13.setVerticalSpacing(20)
        self.gridLayout_13.setObjectName(_fromUtf8("gridLayout_13"))
        self.label_16 = QtGui.QLabel(self.frmWizConflict)
        self.label_16.setObjectName(_fromUtf8("label_16"))
        self.gridLayout_13.addWidget(self.label_16, 1, 0, 1, 1)
        self.label_17 = QtGui.QLabel(self.frmWizConflict)
        self.label_17.setObjectName(_fromUtf8("label_17"))
        self.gridLayout_13.addWidget(self.label_17, 3, 0, 1, 1)
        self.cboConflictOccurrence = QtGui.QComboBox(self.frmWizConflict)
        self.cboConflictOccurrence.setMinimumSize(QtCore.QSize(0, 30))
        self.cboConflictOccurrence.setObjectName(_fromUtf8("cboConflictOccurrence"))
        self.gridLayout_13.addWidget(self.cboConflictOccurrence, 1, 1, 1, 1)
        self.txtConflictSolution = QtGui.QTextEdit(self.frmWizConflict)
        self.txtConflictSolution.setMaximumSize(QtCore.QSize(16777215, 100000))
        self.txtConflictSolution.setObjectName(_fromUtf8("txtConflictSolution"))
        self.gridLayout_13.addWidget(self.txtConflictSolution, 3, 1, 1, 1)
        self.vlConflictNotif = QtGui.QVBoxLayout()
        self.vlConflictNotif.setObjectName(_fromUtf8("vlConflictNotif"))
        self.gridLayout_13.addLayout(self.vlConflictNotif, 0, 0, 1, 2)
        self.label_19 = QtGui.QLabel(self.frmWizConflict)
        self.label_19.setObjectName(_fromUtf8("label_19"))
        self.gridLayout_13.addWidget(self.label_19, 2, 0, 1, 1)
        self.txtConflictDescription = QtGui.QTextEdit(self.frmWizConflict)
        self.txtConflictDescription.setObjectName(_fromUtf8("txtConflictDescription"))
        self.gridLayout_13.addWidget(self.txtConflictDescription, 2, 1, 1, 1)
        frmNewSTR.addPage(self.frmWizConflict)
        ...
        frmNewSTR.setTabOrder(self.tvPropInfo, self.cboInheritanceType)
        frmNewSTR.setTabOrder(self.cboInheritanceType, self.cboDeadAlive)
        frmNewSTR.setTabOrder(self.cboDeadAlive, self.dtReceivingDate)
    ...
    def retranslateUi(self, frmNewSTR):
        ...
        self.frmWizRight.setTitle(_translate("frmNewSTR", "Right of Enjoyment ", None))
        self.frmWizRight.setSubTitle(_translate("frmNewSTR", "Specify Ownership Details.", None))
        self.label_5.setText(_translate("frmNewSTR", "Receiving Date", None))
        self.dtReceivingDate.setDisplayFormat(_translate("frmNewSTR", "yyyy", None))
        self.label_3.setText(_translate("frmNewSTR", "Inheritance type", None))
        self.label_4.setText(_translate("frmNewSTR", "State", None))
        ...
        self.groupBox_3.setTitle(_translate("frmNewSTR", "Property Ownership Type:", None))
        self.rbPrivateProperty.setText(_translate("frmNewSTR", "Private Property", None))
        self.rbStateland.setText(_translate("frmNewSTR", "Stateland", None))
        self.gpPrivateTaxInfo.setTitle(_translate("frmNewSTR", "Tax Information:", None))
        self.label_10.setText(_translate("frmNewSTR", "Last Year CFBP Was Paid", None))
        self.dtLastYearCFBP.setDisplayFormat(_translate("frmNewSTR", "yyyy", None))
        self.label_11.setText(_translate("frmNewSTR", "Amount of CFBP", None))
        self.btnPrivateReceiptScan.setText(_translate("frmNewSTR", "Add Receipt Scan", None))
        self.btnAddTitleDeed.setText(_translate("frmNewSTR", "Add Title Deed", None))
        self.btnAddStatRefPaper.setText(_translate("frmNewSTR", "Add Statutory Reference Paper", None))
        self.btnAddSurveyorRef.setText(_translate("frmNewSTR", "Add Surveyor Reference", None))
        self.btnAddNotaryRef.setText(_translate("frmNewSTR", "Add Notary Reference", None))
        ...
        self.frmWizConflict.setTitle(_translate("frmNewSTR", "Conflict Information", None))
        self.frmWizConflict.setSubTitle(_translate("frmNewSTR", "Provide details on past or present conflicts over land and property.", None))
        self.label_16.setText(_translate("frmNewSTR", "State", None))
        self.label_17.setText(_translate("frmNewSTR", "Solution", None))
        self.label_19.setText(_translate("frmNewSTR", "Description", None))
