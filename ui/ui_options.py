...
class Ui_DlgOptions(object):
    def setupUi(self, DlgOptions):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 604, 516))
        ...
        self.gridLayout_5.addWidget(self.groupBox, 1, 0, 1, 4)
        ...
        self.gridLayout_5.addWidget(self.cbo_profiles, 0, 2, 1, 2)
        ...
        self.gridLayout_5.addWidget(self.txtRepoLocation, 2, 2, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.btn_supporting_docs, 2, 3, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.upgradeButton, 5, 1, 1, 1)
    ...
    def retranslateUi(self, DlgOptions):
        ...
        self.label_9.setText(_translate("DlgOptions", "Upgrade STDM Configuration to 1.2 ", None))
