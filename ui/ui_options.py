...
#
# Created: Mon Jul 05 10:36:15 2021
...
class Ui_DlgOptions(object):
    def setupUi(self, DlgOptions):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 608, 557))
        ...
        self.groupBox_3.setMaximumSize(QtCore.QSize(16777215, 135))
        ...
        self.btn_exportkobocerts = QtGui.QToolButton(self.groupBox_4)
        self.btn_exportkobocerts.setObjectName(_fromUtf8("btn_exportkobocerts"))
        self.btn_exportkobocerts.setMinimumSize(QtCore.QSize(0, 30))
        self.gridLayout_8.addWidget(self.btn_exportkobocerts, 3, 3, 1, 2, QtCore.Qt.AlignRight)
        ...
        self.gridLayout_5.addWidget(self.groupBox_4, 7, 0, 1, 5)
        ...
        self.edtMapfile.setReadOnly(True)
        ...
        self.gridLayout_5.addLayout(self.gridLayout_6, 8, 0, 1, 5)
    ...
    def retranslateUi(self, DlgOptions):
        ...
        self.btn_exportkobocerts.setText(_translate("DlgOptions", "Kobo- Certs", None))
