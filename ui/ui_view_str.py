...
class Ui_frmManageSTR(object):
    def setupUi(self, frmManageSTR):
        ...
        self.tree_scrollArea = QtGui.QScrollArea(self.groupBox_2)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 424, 85))
        ...
        self.page_1.setGeometry(QtCore.QRect(0, 0, 486, 333))
        ...
        self.page_2.setGeometry(QtCore.QRect(0, 0, 486, 326))
