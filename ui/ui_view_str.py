...
class Ui_frmManageSTR(object):
    def setupUi(self, frmManageSTR):
        ...
        self.addSTR = QtGui.QPushButton(self.groupBox_2)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/stdm/images/icons/add.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.addSTR.setIcon(icon2)
        self.addSTR.setObjectName(_fromUtf8("addSTR"))
        self.horizontalLayout_3.addWidget(self.addSTR)
        self.editSTR = QtGui.QPushButton(self.groupBox_2)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/stdm/images/icons/edit.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.editSTR.setIcon(icon3)
        self.editSTR.setObjectName(_fromUtf8("editSTR"))
        self.horizontalLayout_3.addWidget(self.editSTR)
        self.deleteSTR = QtGui.QPushButton(self.groupBox_2)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/stdm/images/icons/remove.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.deleteSTR.setIcon(icon4)
        self.deleteSTR.setObjectName(_fromUtf8("deleteSTR"))
        self.horizontalLayout_3.addWidget(self.deleteSTR)
    ...
    def retranslateUi(self, frmManageSTR):
        ...
        self.addSTR.setText(_translate("frmManageSTR", "Add", None))
        self.editSTR.setText(_translate("frmManageSTR", "Edit", None))
        self.deleteSTR.setText(_translate("frmManageSTR", "Delete", None))
