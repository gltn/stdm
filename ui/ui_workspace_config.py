...
class Ui_STDMWizard(object):
    def setupUi(self, STDMWizard):
        ...
        self.lblTDescription.setStyleSheet(_fromUtf8("color: rgb(0, 85, 0);"))
        ...
        self.gridLayout_18 = QtGui.QGridLayout(self.tab)
        self.gridLayout_18.setObjectName(_fromUtf8("gridLayout_18"))
        self.groupBox_4 = QtGui.QGroupBox(self.tab)
        self.groupBox_4.setMinimumSize(QtCore.QSize(550, 0))
        ...
        self.gridLayout_18.addWidget(self.groupBox_4, 0, 1, 1, 1)
        ...
        self.gridLayout_18.addWidget(self.frame_5, 1, 0, 1, 1)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 831, 479))
    ...
    def retranslateUi(self, STDMWizard):
        ...
        self.label_3.setText(_translate("STDMWizard", "A profile in STDM tool refers to a description of a survey or forms of survey based on a particular data collection methodology and therefore the methodology workflow need to be customized within it. ", None))
