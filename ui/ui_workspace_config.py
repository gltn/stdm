...
#
# Created: Mon Nov 24 17:19:15 2014
...
class Ui_STDMWizard(object):
    def setupUi(self, STDMWizard):
        ...
        self.gridLayout_19.addWidget(self.btnPropDel, 1, 2, 1, 1)
        ...
        self.gridLayout_14.addWidget(self.groupBox_13, 0, 1, 1, 1)
        ...
        self.btnGeomDel.setMaximumSize(QtCore.QSize(50, 40))
        self.btnGeomDel.setIcon(icon)
        ...
        self.btnGeomEdit.setMaximumSize(QtCore.QSize(50, 40))
    ...
    def retranslateUi(self, STDMWizard):
        ...
        self.groupBox_13.setTitle(_translate("STDMWizard", "Relation", None))
        ...
        self.groupBox_12.setTitle(_translate("STDMWizard", "Geometry", None))
        self.btnGeomDel.setText(_translate("STDMWizard", "Del", None))
        self.btnGeomEdit.setText(_translate("STDMWizard", "Edit", None))
