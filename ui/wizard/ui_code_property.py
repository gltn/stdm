...
class Ui_CodeProperty(object):
    def setupUi(self, CodeProperty):
        ...
        self.column_code_view.setDragEnabled(True)
        self.column_code_view.setDragDropOverwriteMode(False)
        self.column_code_view.setDragDropMode(QtGui.QAbstractItemView.InternalMove)
        ...
        self.hide_prefix_lbl = QtGui.QLabel(CodeProperty)
        self.hide_prefix_lbl.setObjectName(_fromUtf8("hide_prefix_lbl"))
        self.gridLayout.addWidget(self.hide_prefix_lbl, 7, 0, 1, 2)
        self.hide_prefix_chk = QtGui.QCheckBox(CodeProperty)
        self.hide_prefix_chk.setText(_fromUtf8(""))
        self.hide_prefix_chk.setObjectName(_fromUtf8("hide_prefix_chk"))
        self.gridLayout.addWidget(self.hide_prefix_chk, 7, 2, 1, 1)
    ...
    def retranslateUi(self, CodeProperty):
        ...
        self.hide_prefix_lbl.setText(_translate("CodeProperty", "Hide prefix:", None))
