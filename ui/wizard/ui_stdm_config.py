...
#
# Created: Wed Feb 24 11:46:40 2016
...
class Ui_STDMWizard(object):
    def setupUi(self, STDMWizard):
        ...
        self.edtOutputPath.setGeometry(QtCore.QRect(152, 140, 330, 30))
        ...
        self.edtTemplatePath.setGeometry(QtCore.QRect(150, 230, 330, 30))
        ...
        self.label_4.setGeometry(QtCore.QRect(14, 237, 131, 16))
        ...
        self.btnDocOutput.setGeometry(QtCore.QRect(486, 139, 70, 30))
        ...
        self.edtDocPath.setGeometry(QtCore.QRect(152, 40, 330, 30))
        ...
        self.btnTemplates.setGeometry(QtCore.QRect(483, 230, 70, 30))
        ...
        self.btnDocPath.setGeometry(QtCore.QRect(487, 40, 70, 30))
        ...
        self.cboParty.setGeometry(QtCore.QRect(160, 50, 271, 30))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 569, 375))
        ...
        STDMWizard.setTabOrder(self.btnDocPath, self.btnDocOutput)
        STDMWizard.setTabOrder(self.btnDocOutput, self.btnTemplates)
        STDMWizard.setTabOrder(self.btnTemplates, self.edtDocPath)
        STDMWizard.setTabOrder(self.edtDocPath, self.edtOutputPath)
        STDMWizard.setTabOrder(self.edtOutputPath, self.edtTemplatePath)
        STDMWizard.setTabOrder(self.edtTemplatePath, self.rbAccpt)
        ...
        STDMWizard.setTabOrder(self.btnDeleteEntity, self.lvEntities)
        STDMWizard.setTabOrder(self.lvEntities, self.btnDeleteColumn)
        ...
        STDMWizard.setTabOrder(self.cboSPUnit, self.scrollArea)
        STDMWizard.setTabOrder(self.scrollArea, self.txtHtml)
        STDMWizard.setTabOrder(self.txtHtml, self.txtLicense)
    ...
    def retranslateUi(self, STDMWizard):
        ...
        self.edtOutputPath.setPlaceholderText(_translate("STDMWizard", "Enter path to save generated documents", None))
        self.edtTemplatePath.setPlaceholderText(_translate("STDMWizard", "Enter path to save document templates", None))
        ...
        self.edtDocPath.setPlaceholderText(_translate("STDMWizard", "Enter path to save entity supporting documents", None))
        ...
        self.wpSaveProfile.setSubTitle(_translate("STDMWizard", "Click finish to save your profile changes to the database. Saving progress will be displayed in the window below. ", None))
