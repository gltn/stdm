...
#
# Created: Fri Nov 25 05:54:48 2016
...
class Ui_STDMWizard(object):
    def setupUi(self, STDMWizard):
        ...
        STDMWizard.setMinimumSize(QtCore.QSize(520, 100))
        ...
        self.horizontalLayout_6.addWidget(self.cboProfile)
        ...
        self.horizontalLayout_6.addWidget(self.btnPDelete)
        ...
        self.horizontalLayout_3.addWidget(self.lblDesc)
        ...
        self.gridLayout_4 = QtGui.QGridLayout(self.wpSTR)
        ...
        self.dg_tenure.setMinimumSize(QtCore.QSize(500, 320))
        self.dg_tenure.setObjectName(_fromUtf8("dg_tenure"))
        self.gridLayout_4.addWidget(self.dg_tenure, 0, 2, 3, 1)
        ...
        self.gridLayout_4.addWidget(self.lblPartyDesc, 1, 1, 1, 1)
        self.lblSpDesc = QtGui.QLabel(self.wpSTR)
        self.lblSpDesc.setText(_fromUtf8(""))
        self.lblSpDesc.setObjectName(_fromUtf8("lblSpDesc"))
        self.gridLayout_4.addWidget(self.lblSpDesc, 2, 1, 1, 1)
        self.frame = QtGui.QFrame(self.wpSTR)
        self.frame.setMinimumSize(QtCore.QSize(165, 0))
        ...
        self.cboParty = QtGui.QComboBox(self.frame)
        ...
        self.gridLayout_3.addWidget(self.cboParty, 1, 0, 1, 1)
        self.cbMultiParty = QtGui.QCheckBox(self.frame)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_3.addWidget(self.cbMultiParty, 2, 0, 1, 1)
        self.label_6 = QtGui.QLabel(self.frame)
        self.label_6.setMinimumSize(QtCore.QSize(0, 0))
        self.label_6.setMaximumSize(QtCore.QSize(300, 16777215))
        self.label_6.setObjectName(_fromUtf8("label_6"))
        self.gridLayout_3.addWidget(self.label_6, 3, 0, 1, 1)
        self.cboSPUnit = QtGui.QComboBox(self.frame)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_3.addWidget(self.cboSPUnit, 4, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.frame, 0, 0, 3, 2)
        ...
        STDMWizard.setTabOrder(self.btnEditLkupValue, self.cboParty)
    ...
    def retranslateUi(self, STDMWizard):
        ...
        self.label.setText(QtGui.QApplication.translate("STDMWizard", "Select", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.lblDesc.setText(QtGui.QApplication.translate("STDMWizard", "TextLabel", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.wpSTR.setTitle(QtGui.QApplication.translate("STDMWizard", "Define Social Tenure Tables", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label_5.setText(QtGui.QApplication.translate("STDMWizard", "1. Select the party entity", None, QtGui.QApplication.UnicodeUTF8))
...
"linked to a single spatial unit", None, QtGui.QApplication.UnicodeUTF8))
        self.label_6.setText(QtGui.QApplication.translate("STDMWizard", "2. Set the spatial unit entity", None, QtGui.QApplication.UnicodeUTF8))
