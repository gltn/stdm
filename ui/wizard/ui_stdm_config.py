...
class Ui_STDMWizard(object):
    def setupUi(self, STDMWizard):
        ...
        STDMWizard.setMinimumSize(QtCore.QSize(480, 100))
        ...
        spacerItem3 = QtGui.QSpacerItem(400, 40, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout_3.addItem(spacerItem3, 5, 2, 1, 1)
        spacerItem4 = QtGui.QSpacerItem(20, 340, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.gridLayout_3.addItem(spacerItem4, 6, 1, 1, 1)
        spacerItem5 = QtGui.QSpacerItem(400, 40, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        ...
        spacerItem6 = QtGui.QSpacerItem(20, 400, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        ...
        self.gridLayout_3.addWidget(self.cboParty, 4, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.cbMultiParty, 5, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.lblPartyDesc, 6, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.lblSpDesc, 8, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.cboSPUnit, 8, 1, 1, 1)
        spacerItem7 = QtGui.QSpacerItem(20, 400, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
    ...
    def retranslateUi(self, STDMWizard):
        ...
        self.cbMultiParty.setText(_translate("STDMWizard", "Allow multiple parties to be linked to a single spatial unit", None))
